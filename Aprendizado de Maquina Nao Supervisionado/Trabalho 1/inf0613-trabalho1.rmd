...
setwd("/Users/nkuros/Documents/mineiracao_dados_complexos/Aprendizado de Maquina Nao Supervisionado/Trabalho 1")
...
```{r atv1-code}
# Ler transações
transactions <- read.transactions("./bakery.csv", format="basket", 
                                sep=",")
